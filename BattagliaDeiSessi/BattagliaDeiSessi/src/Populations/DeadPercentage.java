...
public class DeadPercentage
{
    public DeadPercentage(List<PeopleFactory> popolazionePassata)
    {
        ...
        this.popolazionePassata = popolazionePassata;
    }
    ...
    public synchronized List<PeopleFactory> afterDeath(int percentageDeathBehaviour)
    {
        ...
        */
        ...
        /*
        morigeratiNumero=0;
        avventurieriNumero=0;
        prudentiNumero=0;
        spregiudicateNumero=0;
        ...
        System.out.println("morigerati dopo: "+morigeratiNumero);
        System.out.println("avventurieri dopo: "+avventurieriNumero);
        System.out.println("prudenti dopo: "+prudentiNumero);
        System.out.println("spregiudicate dopo: "+spregiudicateNumero);
        */

...
public interface MeetingStrategyFactory {
    ...
    void MeetingStrategy(PeopleFactory primaPersonaRandom, PeopleFactory secondaPersonaRandom,
    ...
    List<PeopleFactory> getNuovaPopolazione();
    ...
    void setNuovaPopolazione(List<PeopleFactory> nuovaPopolazione, ExecutorService exec);
}

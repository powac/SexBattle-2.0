...
public class OverXvalueStrategy implements MeetingStrategyFactory {
            ...
            if (primaPersonaRandom.getBehaviour().equals(PeopleFactory.Behaviour.Avventuriero) &&
                ...
                if(nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).getHp() >= 0 &&
                    ...
                    if (nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).getHp() > a*3) {
                        ...
                        nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).setHp((float) (nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).getHp() - a*3));
                    }
                    if (nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).getHp() > a*3) {
                        ...
                        nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).setHp(nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).getHp() - a*3);
                    }
                }
                        ...
                        nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).getHp() >= 0)
                {
                    if (nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).getHp() > a*3) {
                        nuovaPopolazione.add(new People(primaPersonaRandom.getBehaviour(), Population.year, 0.0));
                        nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).setHp(nuovaPopolazione.get(nuovaPopolazione.indexOf(primaPersonaRandom)).getHp() - a*3);
                    }
                    if (nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).getHp() > a*3) {
                        nuovaPopolazione.add(new People(secondaPersonaRandom.getBehaviour(), Population.year, 0.0));
                        nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).setHp((float) (nuovaPopolazione.get(nuovaPopolazione.indexOf(secondaPersonaRandom)).getHp() - a*3));
                    }
                }
